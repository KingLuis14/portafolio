---
titlePage: box model
descriptionPage: El modelo de caja de CSS es un concepto fundamental que describe cómo se estructuran y se renderizan los elementos en una página web. Cada elemento se representa como una caja rectangular, y el modelo de caja proporciona un marco para entender y manipular estas cajas.
cardTitle: Box Model css
...
<PictureImg {...borderBox} aspectRatio="Auto"/>
